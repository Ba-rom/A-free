...
def judge(request):  
    ...
    if request.method == 'POST':
        ...
        a1 = a[:-4]
        afree('C:\\Users\\ISABELLA\\Desktop\\A-free-pose\\'+a)
        os.rename('C:\\Users\\ISABELLA\\Desktop\\A-free-pose\\'+a1+'_tf_out.mp4', 
        'C:\\Users\\ISABELLA\\Desktop\\A-free-pose\\firstapp\\static\\image\\'+a1+'_tf_out.mp4')
